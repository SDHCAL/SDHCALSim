...
//
//
// $Id: LyonDetectorFieldSetup.hh,v 1.2 2006/06/29 17:17:12 gunter Exp $
...
#ifndef LyonDetectorFieldSetup_H
#define LyonDetectorFieldSetup_H
...
class LyonDetectorFieldMessenger;
class LyonDetectorFieldSetup 
{
public:

  LyonDetectorFieldSetup(G4ThreeVector) ;  //  The value of the field
  LyonDetectorFieldSetup() ;               //  A zero field

 ~LyonDetectorFieldSetup() ;  
...
private:
  ...
  LyonDetectorFieldMessenger*      fFieldMessenger;
